...
describe('withheld editions are never offered', () => {
  ...
  it('keeps them out of the registry itself', () => {
    ...
    expect(bible.editions.map(edition => edition.key).sort()).toEqual(['bsb-en', 'kjv-en', 'web-en', 'webc-en'])
  })
  ...
  it('keeps them out of the book page and its edition picker', () => {
    ...
    expect(detail.book.editions.map(edition => edition.key).sort()).toEqual(['bsb-en', 'kjv-en', 'web-en', 'webc-en'])
  ...
  it('keeps them out of the lab reader’s version switcher and Compare selector', () => {
    ...
    expect(bibleEditions().map(edition => edition.key).sort()).toEqual(['bsb-en', 'kjv-en', 'web-en', 'webc-en'])
