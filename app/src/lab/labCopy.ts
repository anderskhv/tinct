export const LAB_COPY = {
  ...
  askHistoryLoading: 'Loading your saved conversations…',
  askHistorySyncing: 'Checking for newer conversations…',
  askUnanswered: 'No answer — this question did not get through.',
  askPlaceholder: 'Ask',
  ...
  accountTitle: 'Keep exploring with AI',
  accountBody: 'You’ve used your 10 free AI interactions. Keep reading without an account, or create one for your first month of AI free.',
