...
- Desktop Zoom in / Zoom out buttons visibly enlarge the selected shelf; phone Full library / Closer look buttons and scene-only two-finger pinch change the camera view. Chromium desktop trackpad pinch (ctrl-wheel) also changes the scene zoom; ordinary scrolling and gestures outside the scene remain native. Single-finger vertical scrolling remains available.
