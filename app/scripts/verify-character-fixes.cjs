...
const CASES = [
  ...
  ['jane-eyre', 'original-en', 1, 'jane', 'Eyre', 'je-jane-bare-alias'],
  ...
  ['jane-eyre', 'modern-en', 1, 'jane', 'Eyre', 'je-modern-jane-bare-alias'],
  ...
  ['crime-and-punishment', 'original-en', 11, 'nikolai', 'Mikolka', 'cp-nikolay-alias-ch11'],
  ...
  ['crime-and-punishment', 'original-en', 24, 'lazarus', undefined, 'cp-lazarus'],
  ...
  ['niels-lyhne', 'original-en', 7, 'mrs-boye', undefined, 'nl-mrs-boye-ch7'],
  ...
  // Montaigne second sweep
  ['essays-montaigne', 'original-en', 36, 'aristodemus-spartan', 'Aristodemus', 'mo2-aristodemus-spartan'],
  ['essays-montaigne', 'original-en', 98, 'aristodemus-messenian', 'Aristodemus', 'mo2-aristodemus-messenian'],
  ['essays-montaigne', 'original-en', 42, 'alfonso-of-aragon', 'Alfonso', 'mo2-alfonso-aragon'],
  ['essays-montaigne', 'original-en', 25, 'menander', 'Menander', 'mo2-menander-poet'],
  ['essays-montaigne', 'original-en', 93, 'menander-officer', 'Menander', 'mo2-menander-officer'],
  ['essays-montaigne', 'original-en', 86, 'amurath-ii', 'Amurath', 'mo2-amurath-ii'],
  ['essays-montaigne', 'original-en', 78, 'amurath-iii', 'Amurath', 'mo2-amurath-iii'],
  ['essays-montaigne', 'original-en', 1, 'conrad-iii', 'Conrad', 'mo2-conrad-iii'],
  ['essays-montaigne', 'original-en', 1, 'guelph', 'Guelph', 'mo2-guelph'],
  ['essays-montaigne', 'original-en', 99, 'archelaus-king', 'Archelaus', 'mo2-archelaus-king'],
  ['essays-montaigne', 'original-en', 50, 'timon-man-hater', 'Timon', 'mo2-timon-man-hater'],
  ['essays-montaigne', 'original-en', 69, 'timon-of-phlius', 'Timon', 'mo2-timon-phlius'],
  ['essays-montaigne', 'original-en', 1, 'edward-black-prince', 'Edward', 'mo2-edward-black-prince'],
  ['essays-montaigne', 'original-en', 80, 'edward-iii', undefined, 'mo2-edward-iii'],
  ['essays-montaigne', 'original-en', 37, 'rene-of-lorraine', 'Rene', 'mo2-rene-lorraine'],
  ['essays-montaigne', 'original-en', 96, 'montaigne-himself', undefined, 'mo2-michel-de-montaigne'],
  ['essays-montaigne', 'original-en', 2, 'psammenitus', 'Psammenitus', 'mo2-psammenitus'],
  ['essays-montaigne', 'original-en', 11, 'xenophanes', 'Xenophanes', 'mo2-xenophanes'],
  ['essays-montaigne', 'original-en', 59, 'anaxarchus', 'Anaxarchus', 'mo2-anaxarchus'],
  ['essays-montaigne', 'original-en', 90, 'mohammed-ii', 'Mohammed', 'mo2-mohammed-ii'],
  ['essays-montaigne', 'original-en', 81, 'suleiman', 'Solyman', 'mo2-solyman'],
  ['essays-montaigne', 'original-en', 65, 'leonora', 'Leonora', 'mo2-leonora'],
  ['essays-montaigne', 'original-en', 24, 'lucullus', 'Lucullus', 'mo2-lucullus'],
  ['essays-montaigne', 'original-en', 101, 'asinius-pollio', 'Pollio', 'mo2-pollio'],
  ['essays-montaigne', 'original-en', 3, 'nicias', 'Nicias', 'mo2-nicias'],
  ['essays-montaigne', 'original-en', 20, 'mary-germain', 'Mary', 'mo2-mary-germain'],
  ['essays-montaigne', 'modern-en', 2, 'psammenitus', undefined, 'mo2-modern-psammenitus'],
  ['essays-montaigne', 'modern-en', 24, 'lucullus', undefined, 'mo2-modern-lucullus'],
  // Comedies: Shrew / Tempest / As You Like It
  ['taming-of-the-shrew', 'original-en', 3, 'katherina', 'Katherina', 'sh-kate'],
  ['taming-of-the-shrew', 'original-en', 3, 'lucentio', 'Lucentio', 'sh-cambio'],
  ['taming-of-the-shrew', 'original-en', 7, 'pedant', undefined, 'sh-pedant'],
  ['taming-of-the-shrew', 'original-en', 8, 'tailor', undefined, 'sh-tailor'],
  ['taming-of-the-shrew', 'original-en', 12, 'widow', undefined, 'sh-widow'],
  ['taming-of-the-shrew', 'original-en', 6, 'nathaniel', 'Nathaniel', 'sh-nathaniel'],
  ['taming-of-the-shrew', 'original-en', 2, 'baptista', 'Baptista', 'sh-minola'],
  ['taming-of-the-shrew', 'modern-en', 3, 'katherina', undefined, 'sh-modern-kate'],
  ['the-tempest', 'original-en', 8, 'iris', 'Iris', 'tp-iris'],
  ['the-tempest', 'original-en', 8, 'ceres', 'Ceres', 'tp-ceres'],
  ['the-tempest', 'original-en', 8, 'juno', 'Juno', 'tp-juno'],
  ['the-tempest', 'original-en', 3, 'claribel', 'Claribel', 'tp-claribel'],
  ['the-tempest', 'original-en', 2, 'setebos', 'Setebos', 'tp-setebos'],
  ['the-tempest', 'original-en', 2, 'alonso', 'Alonso', 'tp-king-of-naples'],
  ['the-tempest', 'original-en', 1, 'ship-master', undefined, 'tp-master'],
  ['as-you-like-it', 'original-en', 10, 'sir-oliver-martext', 'Martext', 'ay-martext'],
  ['as-you-like-it', 'original-en', 14, 'oliver', 'Oliver', 'ay-oliver-ch14'],
  ['as-you-like-it', 'original-en', 17, 'hymen', 'Hymen', 'ay-hymen'],
  ['as-you-like-it', 'original-en', 17, 'jaques-de-boys', undefined, 'ay-jaques-de-boys'],
  ['as-you-like-it', 'original-en', 17, 'jaques', 'Jaques', 'ay-jaques-ch17'],
  ['as-you-like-it', 'original-en', 9, 'rosalind', 'Rosalind', 'ay-ganymede'],
  ['as-you-like-it', 'original-en', 5, 'celia', 'Celia', 'ay-aliena'],
  ['as-you-like-it', 'original-en', 1, 'sir-rowland', 'Rowland', 'ay-sir-rowland'],
  ['as-you-like-it', 'original-en', 1, 'fortune', 'Fortune', 'ay-fortune'],
  ['as-you-like-it', 'modern-en', 10, 'sir-oliver-martext', undefined, 'ay-modern-martext'],
  // Residual sweep: Histories deities, War and Peace marshals/Tikhons, Moby-Dick allusions
