...
// Version the stylesheet and module graph together for previously cached pages.
{
  ...
  const pattern = new RegExp('(' + names.map(n => n.replaceAll('.', '\\.')).join('|') + ')(?!\\?v=stable-joke-20260914)', 'g');
  ...
  for (const path of paths) {
    ...
    const after = before.replaceAll('?v=reveal-20260914', '').replaceAll('?v=polish-20260914', '').replaceAll('?v=image2-20260914', '').replaceAll('?v=joke-20260914', '').replace(pattern, '$1?v=stable-joke-20260914');
