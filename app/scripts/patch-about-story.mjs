...
for (const f of ['about-v21.css', 'about-v21.js', 'assets/library-desktop-v1.webp', 'assets/reader-page-v1.jpg', 'assets/devices-transparent-v10.webp']) {
...
const edits = [
  ...
  ['story', 'audio starts at the car on narrow screens', '!t&&n.index===4?(0,_.jsx)(eo,{progress:Math.min(1,u/.88)})', '!t&&n.index===4?(0,_.jsx)(eo,{progress:window.innerWidth<=1024?.345+.655*Math.min(1,u/.88):Math.min(1,u/.88)})', 1],
  ...
  ['story', 'scene speed cap', 'i({...s,overload:u,travel:d})',
    '{let z=$[s.index]?.id,m=z===`infinite`?.022:z===`introducing`?.008:.03,p=s.progress,q=Ro.o===null?u:Math.max(Ro.o-.022,Math.min(Ro.o+.022,u)),g=Ro.i===s.index&&Ro.v!==null?Math.max(Ro.v-m,Math.min(Ro.v+m,p)):p;Ro.o=q,Ro.v=g,Ro.i=s.index,(q!==u||g!==p)&&Ro.k&&Ro.k(),i({...s,progress:g,overload:q,travel:d})}', 1],
