...
Replace the blanket edition hold with a chapter 10 hold. The reader checks that hold before playback and clears an unavailable notice when the chapter changes. Saved places remain unchanged. Chapter 10 audio remains an explicit outstanding recording repair; other chapters are selectable and playable.
