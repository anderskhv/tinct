...
- Earlier production voice-lab run 35620497044 did not reach a provider handshake because its legacy script waited for the removed `Voice test room` heading. Run 35626314287 supersedes that stale route/selector failure for voice support.
...
the current production bundle is `index-CdxhFG7Y.js`.
