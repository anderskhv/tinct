...
Use ordinary vocabulary and natural sentence structure. One source sentence may become several; keep sentence-level coverage, not sentence-for-sentence structure. Split difficult sentences where it helps, but avoid a run of choppy sentences: vary rhythm. Briefly explain an essential unfamiliar concept inside the prose where the source supports it (for example, a few words identifying who Lavater was), without turning literature into commentary. Retain necessary philosophical or technical terms with minimal clarification. Keep the author's voice. Already-clear sentences may stay unchanged.

Two habits the pilots showed, both to avoid: (a) when you split a long sentence, do not add intensifiers or connectives ("actually", "entirely", "at all", "in particular", "therefore") that the source lacks, and never remove a small word that carries the argument ("again", "still", "only", "itself"); (b) do gloss. A reference a new reader cannot place gets a minimal identifying tag that states a category or fact and adds no claim: "the historian Thiers", "Rousseau's Le Contrat Social (The Social Contract)", "the statesmen and writers Stein, Metternich…". No dates, no biography, no explanation of their views. Both drafters in the pilot under-glossed and both added intensifiers; the reviews will catch it, but it costs a round. There is no rewrite quota and no sentence-length target.
