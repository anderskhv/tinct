# Odyssey Book 12 — checks, candidate v1
...
**Subject:** `book12/candidate-v1.json`, sha256 `4e9798731cffa034cb32ee4aca4a9edfec49d5cd469e673ccae4782914978245`.
...
- D20 growth gate: a sentence grew past 50 words — P016 54→55; P022 70→71; P027 56→57; P031 79→81; P037 68→70
- paragraphs below 0.90 of their source's length: [1, 2, 3, 4, 9, 10], but book12/candidate-v1.json declares []
- cross-Book compound drift ['seagulls', 'seawater'], but book12/candidate-v1.json declares [] — seagulls {'closed': ['book03'], 'hyphenated': ['book12-v1']}; seawater {'closed': ['book05'], 'open': ['book12-v1']}
...
| word ratio | 0.94944 |
| Butler token retention (canonical, aggregate-join) | **0.82733** |
| order retention (per paragraph, for MOVE-GAP) | 0.82733 |
| bag retention (order-blind) | 0.84913 |
| **MOVE-GAP** (bag − order), D20 | **0.02180** |
| sentences, source → candidate | 127 → 138 |
| **splitting rate** (D17, raw) | **+8.7%** |
| semicolon-normalized sentences | 173 → 171 |
| NORM RATE as published (D20) | -1.2% |
| semicolon-normalized, on Butler's pointing | 173 → 169 |
| **NORM RATE on Butler's own pointing** (D20, S-1) | **-2.3%** |
| sixty-word sentences | 15 → 8 (47% broken) |
| **semicolons, Butler → candidate** (D19) | **46 → 33** |
| **of which KEPT of Butler's / ADDED by the draft** (S-1) | **31 kept + 2 added** |
| **dividing marks, Butler → candidate** (D27: `;` `:` sentence-internal `—`) | **56 → 52** |
| **of which KEPT / ADDED** (D27) | **45 kept + 7 added** |
| dividing-mark-normalized sentences | 183 → 190 |
| NORM RATE, every dividing mark (D27) | +3.8% |
...
| **of which KEPT BY IDENTITY / CLASS-CHANGED / ADDED** (**D28**, Book 9 round 1 S-1) | **41 kept + 4 class-changed + 7 added** |
| dividing-mark-normalized, on Butler's pointing by identity | 183 → 179 |
| **NORM RATE, dividing marks on Butler's pointing BY MARK IDENTITY** — **the compared figure from Book 9 forward** (D28) | **-2.2%** |
...
| B12-P010 | `;` | `—` | …who is scylla mother |
| B12-P010 | `;` | `—` | …scylla mother curse her |
| B12-P018 | `;` | `:` | …these are your orders |

Of the +11 sentences added, at most **13** are a semicolon
...
**2 of this candidate's 33 semicolons are its own**, and the figure
that is COMPARED from Book 7 forward is **NORM RATE on Butler's own
pointing**, -2.3% here against the -1.2% the unsplit measure gives.
...
| Book 12 v1 — **this candidate** | all 39 paragraphs | 0.82733 | 127 → 138 | +8.7% | 46 → 33 | 56 → 52 | 45 + 7 | -1.2% | **+0.0%** | 0.02180 |
...
prose. This candidate: **+8.7%**. Sixty-word survival gate:
8 of 15 survive, and the gate fails above 11.25.
...
- B12-P022 70 → 71 words: ‘Odysseus,’ said he, ‘you are hard; you are very strong yourself and never wear out; you seem to be made of iron, and now, though your men are worn out with toil and lack of sleep, you will not let them land and cook themselves a good supper on this island, but tell them to put out to sea and go on faring fruitlessly through the watches of the swift night.
- B12-P027 56 → 57 words: As long as the corn and wine held out, the men did not touch the cattle, hungry as they were; but when they had eaten everything there was in the ship, they were forced to range farther afield, with hook and line, catching birds and taking whatever they could lay their hands on, for they were starving.
...
| B12-P007 | **40** | 87 | Halfway up it there is a large cave, facing west and turned toward Erebus; you must take your ship this way, but the cav… |
...
| B12-P012 | **47** | 47 | Presently the great and clever goddess Circe sent us a fair wind that blew steady from astern and stayed with us, keepin… |
...
| B12-P022 | **71** | 70 | ‘Odysseus,’ said he, ‘you are hard; you are very strong yourself and never wear out; you seem to be made of iron, and no… |
...
| B12-P027 | **57** | 56 | As long as the corn and wine held out, the men did not touch the cattle, hungry as they were; but when they had eaten ev… |
...
| B12-P034 | **47** | 49 | And indeed the gods soon began to show signs and wonders among us, for the hides of the cattle crawled about, and the me… |
...
| B12-P037 | **70** | 68 | “I clung to the ship until the sea knocked her sides away from her keel, which drifted off by itself, and tore the mast … |
...
|---|---|---|---|
| B12-P036 | 62 | 3 | 35 words |

## 9. One Butler word rendered two ways (per Book, Butler-keyed)

**208 rows.** This report's declared limits, which records finding
...
| `fell` | 1 | 6 | P014, P024, P035, P035, P036, P038 |
| `fire` | 1 | 2 | P020, P036 |
| `flew` | 1 | 1 | P031 |
...
| `in` | 16 | 47 | P005, P007, P007, P007, P007, P007 |
| `indeed` | 2 | 1 | P034 |
...
| `ithaca` | 1 | 1 | P028 |
| `laid` | 1 | 1 | P015 |
| `land` | 1 | 6 | P003, P014, P020, P022, P025, P025 |
...
| `number` | 1 | 1 | P006 |
| `of` | 18 | 100 | P002, P002, P003, P003, P003, P005 |
| `off` | 6 | 5 | P005, P006, P007, P020, P027 |
| `on` | 17 | 23 | P001, P005, P006, P006, P007, P010 |
| `once` | 2 | 5 | P003, P007, P012, P022, P028 |
| `one` | 3 | 18 | P006, P006, P007, P007, P013, P013 |
| `only` | 2 | 3 | P006, P015, P019 |
| `other` | 2 | 6 | P008, P020, P027, P028, P030, P031 |
| `our` | 2 | 11 | P001, P004, P012, P013, P015, P015 |
...
| `the` | 27 | 264 | P001, P001, P001, P001, P001, P002 |
...
| `to` | 30 | 96 | P002, P002, P002, P003, P003, P003 |
| `too` | 1 | 4 | P005, P038, P038, P038 |
| `top` | 1 | 3 | P002, P007, P029 |
| `up` | 5 | 13 | P005, P007, P013, P014, P018, P020 |
...
| `who` | 1 | 11 | P003, P005, P005, P010, P011, P013 |
...
Result over book01, book02, book03, book04, book05, book06, book07, book08, book09: **seagulls {'closed': ['book03'], 'hyphenated': ['book12-v1']}; seawater {'closed': ['book05'], 'open': ['book12-v1']}**.
...
> `best men` · `caught hold` · `dead men` · `either side` · `fifty head` · `fine work` · `fresh water` · `frightful head` · `give way` · `gray sea` · `great fire` · `green field` · `laid pieces` · `like water` · `little pieces` · `little water` · `losing men` · `nine days` · `nymphs hold` · `open sea` · `salt sea` · `salt water` · `sea water` · `seventh day` · `single head` · `six days` · `six heads` · `six men` · `struggling men` · `swift night` · `tenth night` · `whole sea` · `with fire`
