# Odyssey Book 7 — checks, candidate v1
...
**Subject:** `book07/candidate-v1.json`, sha256 `bf8cf2f76f4670daab55daf1da265ba7b1839c0cd6680e3c5691fac8d382dc33`.
...
| word ratio | 1.00538 |
| Butler token retention (canonical, aggregate-join) | **0.93943** |
| order retention (per paragraph, for MOVE-GAP) | 0.93943 |
| bag retention (order-blind) | 0.95220 |
| **MOVE-GAP** (bag − order), D20 | **0.01277** |
| sentences, source → candidate | 103 → 129 |
| **splitting rate** (D17, raw) | **+25.2%** |
| semicolon-normalized sentences | 133 → 143 |
| NORM RATE as published (D20) | +7.5% |
| semicolon-normalized, on Butler's pointing | 133 → 137 |
| **NORM RATE on Butler's own pointing** (D20, S-1) | **+3.0%** |
| sixty-word sentences | 7 → 0 (100% broken) |
| **semicolons, Butler → candidate** (D19) | **30 → 14** |
| **of which KEPT of Butler's / ADDED by the draft** (S-1) | **8 kept + 6 added** |

Of the +26 sentences added, at most **16** are a semicolon
...
**6 of this candidate's 14 semicolons are its own**, and the figure
that is COMPARED from Book 7 forward is **NORM RATE on Butler's own
pointing**, +3.0% here against the +7.5% the unsplit measure gives.
...
prose. This candidate: **+25.2%**. Sixty-word survival gate:
...
| B07-P004 | **48** | 46 | I will go in front of you and show the way, but do not say a word as you go, and do not look at any man or ask him quest… |
| B07-P007 | **43** | 50 | Apollo killed the first of them while he was still a bridegroom and without a son; but he left a daughter, Arete, whom A… |
| B07-P010 | **49** | 55 | Here the chief men of the Phaeacians used to sit and eat and drink, for there was abundance at all seasons; and there we… |
...
| B07-P013 | **48** | 75 | “Queen Arete,” he exclaimed, “daughter of great Rhexenor, in my distress I humbly beg you, and your husband too, and the… |
...
| B07-P015 | **47** | 96 | Tell your servants to mix some wine and water so that we may make a drink offering to Zeus the lord of thunder, who take… |
...
| B07-P020 | **47** | 48 | Then, when they had made their drink offerings and had each drunk as much as he wanted, they went home to bed, every man… |
...
| B07-P026 | **43** | 85 | If you will stay I will give you a house and an estate; but no one—heaven forbid—shall keep you here against your own wi… |
...
| B07-P028 | **46** | 46 | So the maids went out with torches in their hands, and when they had made the bed they came up to Odysseus and said, “Ri… |
...
| paragraph | run |
|---|---|
| B07-P013 | «with long life and happiness and may they leave their possessions to their children and all the» |
...
**70 rows.** This report's declared limits, which records finding
...
| `all` | 2 | 22 | P002, P007, P010, P010, P010, P011 |
| `also` | 2 | 3 | P008, P011, P023 |
| `and` | 7 | 142 | P001, P001, P001, P001, P001, P001 |
| `as` | 3 | 28 | P001, P001, P001, P002, P003, P004 |
...
| `is` | 1 | 29 | P006, P006, P006, P006, P006, P007 |
| `itself` | 1 | 2 | P011, P019 |
| `just` | 1 | 2 | P011, P018 |
| `life` | 1 | 1 | P006 |
| `long` | 1 | 4 | P012, P013, P021, P026 |
| `may` | 2 | 9 | P008, P015, P015, P016, P018, P018 |
| `nor` | 2 | 2 | P011, P019 |
| `not` | 1 | 14 | P003, P004, P004, P005, P006, P015 |
| `odysseus` | 2 | 16 | P001, P002, P002, P005, P009, P012 |
| `of` | 1 | 102 | P001, P001, P002, P002, P002, P003 |
| `on` | 3 | 22 | P001, P009, P009, P009, P010, P010 |
...
| `the` | 3 | 200 | P001, P001, P001, P001, P001, P001 |
| `their` | 2 | 14 | P005, P007, P008, P008, P010, P010 |
...
| `to` | 3 | 83 | P001, P001, P001, P002, P002, P002 |
...
| `with` | 1 | 27 | P005, P007, P007, P010, P010, P010 |
...
> `again night` · `arranged beds` · `bad place` · `chief men` · `draw water` · `either side` · `good woman` · `high walls` · `keep house` · `landing place` · `like men` · `long way` · `next day` · `nine days` · `old woman` · `others work` · `outer court` · `seventeen days` · `single day` · `tenth night` · `whole time` · `woven work` · `young men`
