...
|---|---|---|---|
| `besought` | `begged` (B7-P023) | **`variant`** | `begged` in Book 7, `entreated` in Book 10 — and Book 10's was `begged` until this check raised it, at which point the repair had to choose between matching Book 7 and freeing `begged` for Butler's own use. It freed `begged`. **Not repaired in Book 7**, which is accepted: the cost is a successor (ledger R-6) for two synonyms three Books apart, and the rule the package follows is that a cross-Book synonym divergence with no flattening is recorded, not chased. |
...
| `senses` | `senses` (B7-P023) | **`kept`** | every entry Book 7 contributes is Butler's own `senses` carried through unchanged; the decision in this row belongs to whichever Book moved |
...
| key | this Book's entries | disposition | reason |
|---|---|---|---|
| `about` | `about` (B7-P008), `about` (B7-P011), `about` (B7-P012), `about` (B7-P019), `about` (B7-P026) | **`kept`** | every entry Book 7 contributes is Butler's own `about` carried through unchanged; the decision in this row belongs to whichever Book moved |
...
| `aside` | `aside` (B7-P019) | **`kept`** | every entry Book 7 contributes is Butler's own `aside` carried through unchanged; the decision in this row belongs to whichever Book moved |
| `before` | `before` (B7-P009), `before` (B7-P011), `before` (B7-P012), `before` (B7-P020) | **`kept`** | every entry Book 7 contributes is Butler's own `before` carried through unchanged; the decision in this row belongs to whichever Book moved |
...
| `beside` | `along with their husbands` (B7-P007), `beside` (B7-P016) | **`common-rendering`** | `beside` is a word Butler himself uses in 10 paragraphs across seven Books, so its reuse as a rendering is not a decision; arrow B is ungated on this side on purpose and arrow C carries the residue |
...
| `caught` | `caught` (B7-P022) | **`kept`** | every entry Book 7 contributes is Butler's own `caught` carried through unchanged; the decision in this row belongs to whichever Book moved |
...
| `could` | `could` (B7-P005), `could` (B7-P010), `could` (B7-P021), `could` (B7-P022), `could` (B7-P023) | **`kept`** | every entry Book 7 contributes is Butler's own `could` carried through unchanged; the decision in this row belongs to whichever Book moved |
...
| `crossed` | `crossed` (B7-P012) | **`kept`** | every entry Book 7 contributes is Butler's own `crossed` carried through unchanged; the decision in this row belongs to whichever Book moved |
| `drink` | `drink` (B7-P010), `drink` (B7-P012), `drink` (B7-P015), `drink` (B7-P016), `drink` (B7-P017), `drink` (B7-P019), `drink` (B7-P020) | **`kept`** | every entry Book 7 contributes is Butler's own `drink` carried through unchanged; the decision in this row belongs to whichever Book moved |
...
| `helping` | `helping` (B7-P019) | **`kept`** | every entry Book 7 contributes is Butler's own `helping` carried through unchanged; the decision in this row belongs to whichever Book moved |
| `homeward` | `homeward` (B7-P018) | **`variant`** | every rendering in the row reduces to `homeward` once inflection, D9 spelling and D15 compound spacing are normalized |
...
| `husband` | `along with their husbands` (B7-P007), `husband` (B7-P006), `husband` (B7-P013) | **`common-rendering`** | `husband` is a word Butler himself uses in 16 paragraphs across seven Books, so its reuse as a rendering is not a decision; arrow B is ungated on this side on purpose and arrow C carries the residue |
...
| `leave` | `depart` (B7-P022), `leave` (B7-P013) | **`common-rendering`** | `leave` is a word Butler himself uses in 27 paragraphs across seven Books, so its reuse as a rendering is not a decision; arrow B is ungated on this side on purpose and arrow C carries the residue |
...
| `people` | `people` (B7-P001), `people` (B7-P004), `people` (B7-P006), `people` (B7-P008), `people` (B7-P012), `people` (B7-P018), `people` (B7-P023), `people` (B7-P026), `persons` (B7-P010) | **`common-rendering`** | `people` is a word Butler himself uses in 68 paragraphs across seven Books, so its reuse as a rendering is not a decision; arrow B is ungated on this side on purpose and arrow C carries the residue |
...
| `sight` | `sight` (B7-P022) | **`kept`** | every entry Book 7 contributes is Butler's own `sight` carried through unchanged; the decision in this row belongs to whichever Book moved |
...
| `think` | `think` (B7-P026) | **`kept`** | every entry Book 7 contributes is Butler's own `think` carried through unchanged; the decision in this row belongs to whichever Book moved |
...
| `together` | `converse` (B7-P028), `together` (B7-P023) | **`common-rendering`** | `together` is a word Butler himself uses in 18 paragraphs across seven Books, so its reuse as a rendering is not a decision; arrow B is ungated on this side on purpose and arrow C carries the residue |
...
| `under` | `under` (B7-P011), `under` (B7-P015), `under` (B7-P022) | **`kept`** | every entry Book 7 contributes is Butler's own `under` carried through unchanged; the decision in this row belongs to whichever Book moved |
...
| `away` | `home` (B7-P020) | **`common-word`** | `away` is an ordinary word Butler uses in 52 paragraphs and the two uses share no referent |
