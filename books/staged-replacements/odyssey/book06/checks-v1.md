# Odyssey Book 6 — checks, candidate v1
...
**Subject:** `book06/candidate-v1.json`, sha256 `9391ca16778a8225c1710b24296c51a2d3ba33f26ed3ac9fcf7c677c3c0413f0`.
...
| word ratio | 0.99913 |
| Butler token retention (canonical, aggregate-join) | **0.93669** |
| order retention (per paragraph, for MOVE-GAP) | 0.93669 |
| bag retention (order-blind) | 0.94594 |
| **MOVE-GAP** (bag − order), D20 | **0.00925** |
| sentences, source → candidate | 116 → 148 |
| **splitting rate** (D17, raw) | **+27.6%** |
| semicolon-normalized sentences | 143 → 152 |
| **NORM RATE** (D20) | **+6.3%** |
| sixty-word sentences | 7 → 1 (86% broken) |
| **semicolons, Butler → candidate** (D19) | **27 → 4** |

Of the +32 sentences added, at most **23** are a semicolon
...
| Book 6 v1 | all 26 paragraphs | 0.93669 | 116 → 148 | +27.6% | 7 → 1 | 27 → 4 | +6.3% | 0.00925 |
...
| B06-P009 | **60** | 67 | As the huntress Artemis goes out over the mountains of Taygetus or Erymanthus to hunt wild boars or deer, the wood nymph… |
...
| B06-P016 | **43** | 64 | Neither he nor anyone else can come here to do us Phaeacians any harm, for we are dear to the gods, and live apart on a … |
...
| B06-P022 | **48** | 61 | Perhaps he is a vagabond sailor she has picked up from some foreign vessel, for we have no neighbors; or some god has at… |
...
**75 rows.** This report's declared limits, which records finding
...
| `also` | 2 | 2 | P017, P018 |
| `and` | 5 | 164 | P001, P001, P001, P001, P001, P001 |
...
| `she` | 3 | 30 | P002, P002, P004, P004, P005, P005 |
...
| `who` | 1 | 18 | P001, P002, P003, P005, P008, P008 |
| `whom` | 1 | 1 | P015 |
