...
| NORM RATE, dividing marks on Butler's pointing (D27+D21, the compared figure for Books 1-8) | +5.2% |
| **of which KEPT BY IDENTITY / CLASS-CHANGED / ADDED** (**D28**, Book 9 round 1 S-1) | **13 kept + 1 class-changed + 2 added** |
| dividing-mark-normalized, on Butler's pointing by identity | 154 → 161 |
| **NORM RATE, dividing marks on Butler's pointing BY MARK IDENTITY** — **the compared figure from Book 9 forward** (D28) | **+4.5%** |
