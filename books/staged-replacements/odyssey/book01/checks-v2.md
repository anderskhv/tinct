# Odyssey Book 1 — checks, candidate v2
...
**Subject:** `book01/candidate-v2.json`, sha256 `f28a13264288079781a8c8c6cf044ae41d288847dc5d7f23378851a44ba7df45`.
...
| order retention (per paragraph, for MOVE-GAP) | 0.73258 |
...
| B01-P019 | **46** | 53 | Tell the suitors to be off, each to his own home, and if your mother’s mind is set on marrying again, let her go back to… |
...
**233 rows.** This report's declared limits, which records finding
...
| `marry` | 2 | 1 | P017 |
| `may` | 5 | 5 | P019, P019, P027, P028, P029 |
