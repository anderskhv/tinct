# Review Packet 06 — Odyssey Book 10

Assigned paragraphs: B10-P016–B10-P018 (source paragraph index 15–17, 0-based).

Source: Samuel Butler, 1900 (Project Gutenberg #1727), as served in `app/public/data/editions/odyssey-original-en.json`, chapter number 10.

Candidate: modern-English reading edition, frozen draft v1 (`book10/candidate-v1.json`). Name forms follow `GLOSSARY.md`; per-paragraph decisions are in `book10/continuity.md`.

---

## B10-P015 — CONTEXT ONLY — reviewed in another packet
...
## B10-P019 — CONTEXT ONLY — reviewed in another packet
