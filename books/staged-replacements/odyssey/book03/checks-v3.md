# Odyssey Book 3 — checks, candidate v3
...
**Subject:** `book03/candidate-v3.json`, sha256 `a79bacf6fd5f4a995b27d404e38e58790487bd4586bb144c7a0503408554ce1e`.
...
| word ratio | 0.99552 |
| Butler token retention (canonical, aggregate-join) | **0.89598** |
| order retention (per paragraph, for MOVE-GAP) | 0.89598 |
| bag retention (order-blind) | 0.91755 |
...
| Book 3 v3 — **this candidate** | 37 of 38 | 0.89598 | 164 → 173 | +5.5% | 39 → 32 | 53 → 47 | 39 + 8 | +1.0% | **-2.3%** | 0.02156 |
...
**157 rows.** This report's declared limits, which records finding
...
| `sat` | 1 | 2 | P032, P036 |
| `sea` | 1 | 10 | P001, P011, P012, P015, P015, P016 |
| `send` | 1 | 2 | P007, P029 |
| `servants` | 1 | 1 | P007 |
| `since` | 1 | 2 | P016, P030 |
| `sir` | 2 | 2 | P026, P029 |
...
> `best men` · `comfortable beds` · `excellent man` · `fair sea` · `fetched water` · `five ships` · `former days` · `four days` · `grain lands` · `hundred men` · `inner room` · `malean heads` · `open house` · `open sea` · `poured water` · `putting pieces` · `spring water` · `wood fire` · `young men`
