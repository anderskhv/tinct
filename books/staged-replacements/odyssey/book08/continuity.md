...
`book08/candidate-v1.json`; the evidence is **100 served modern-English editions**, read only, and
...
| `down side` | **`not a compound`** | the closed form is attested nowhere in 100 editions |
