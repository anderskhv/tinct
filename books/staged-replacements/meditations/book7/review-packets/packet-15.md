# Review Packet 15 — Meditations, Book 7

Assigned paragraphs: B07-P043–B07-P045 (meditations VII.43–VII.45; source paragraph index 42–44, 0-based).

Source: George Long, 1862 (Project Gutenberg #15877), as staged in `books/staged-replacements/meditations/meditations-original-en.staged.json`, chapter number 7, one paragraph per numbered meditation.
Candidate: modern-English reading edition, frozen draft v1 (`book7/candidate-v1.json`). Renderings of recurring terms follow `GLOSSARY.md`; per-paragraph decisions are in `book7/continuity.md`.

---

## B07-P042 — CONTEXT ONLY — reviewed in another packet
...
## B07-P046 — CONTEXT ONLY — reviewed in another packet
