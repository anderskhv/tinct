# Meditations, Book 8 — modern-English candidate v2

**Title:** Book 8

Candidate v1 with the round-1 independent-review corrections applied (see `changes-v1-to-v2.md`). Paragraph IDs `B08-Pxxx` are for reference only; the leading number is part of the text.
