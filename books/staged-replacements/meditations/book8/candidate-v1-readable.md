# Meditations, Book 8 — modern-English candidate v1

**Title:** Book 8

Paragraph IDs are shown outside the prose, in the form `B08-Pxxx`, for review reference only. They are not part of the edition text. Each paragraph is one numbered meditation; the leading number is part of the text.
