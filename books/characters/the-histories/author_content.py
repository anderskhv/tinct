...
AUTHORING IS IN PROGRESS. Books 1-6 (Clio to Erato, sections 1-1026) are
authored. Books 7-9 are not yet done and the package must not be integrated
until they are.
...
Path(__file__).parent.joinpath('editorial.json').write_text(json.dumps(dict(
 ...
 coverage='Both full English editions. BOOKS 1-6 (Clio, Euterpe, Thalia, Melpomene, Terpsichore and Erato, sections 1-1026) are authored; Books 7-9 are in progress. Named people and named peoples. Cities, rivers, mountains, seas and countries are not cast.',
