...
| The Histories (`the-histories`) | in-progress | Books 1-6 (sections 1-1026) are authored: 595 entities, 10,024 / 9,989 mentions. NEXT: Book 7 (Polymnia, sections 1027-1260) — Thermopylae. Read the Book 6 section of the README first: Xerxes, Mardonius, Datis, Demaratus, Leotychides, the Plataeans, the Sacae, the Helots and the Ephors are already bound forward through Books 7-9 and their cards must be enriched rather than duplicated, and the Otanes, Aristagoras, Aristodemus, Archidamus, Anaxilaus, Agis, Callias, Cleander, Laodamas, Leoprepes, Polycritus, Scythes and Hydarnes tables all have deliberate None defaults or suppressed sections that Book 7 must fill in rather than override. Do not integrate until all nine books are covered. |
