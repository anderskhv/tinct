...
| The Imitation of Christ (`imitation-of-christ`) | in-progress | Lane A authoring claimed: build entity inventory from both English editions, author cards, run editorial checks before validated-package |
