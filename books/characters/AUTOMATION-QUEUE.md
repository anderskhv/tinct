...
what is deliberately not bound. One class of failure here is visible — a missing
entry, or an entry with no mentions — and the coverage tests catch it.

The other class is not visible to any test, and Lane A is not free of it. A
treatise names people too: Hume's two Alexanders and two Catos, The Prince's
three Alexanders and two Dariuses, Locke's biblical genealogy, Kierkegaard's
Abraham and his pseudonym, the Socrates who is Plato's teacher versus the one in
somebody's anecdote. Scripture retold inside an argument is still narrative, and
a citation can name a book, a city or a school rather than a person. Every Lane A
package must therefore pass the editorial checks below before it is called done.
