...
Episodes 1 to 8 are authored. The rest are not.
...
print(len(entities),'entities authored: episodes 1-8')
BASE=Path(__file__).resolve().parent
(BASE/'editorial.json').write_text(json.dumps(dict(
 bookId='ulysses',
 contentVersion='2026-09-15.8',
 coverage='Both full English editions, episodes 1-8 of 18. Named persons, and the writers, saints, heresiarchs and stage figures the characters quote. Peoples, places, newspapers, songs, pubs and shops are not cast.',
