...
4. **Generate translations** — modern English via CLI (zero API spend)
...
|------|----|----------|----------|--------|
| The Odyssey | odyssey | 24 | original-en, verse-en, modern-en | Complete |
| Ulysses | ulysses | 18 | original-en, modern-en | Complete |
