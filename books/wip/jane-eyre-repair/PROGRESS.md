...
| Ch37 (full chapter, preserving sound paragraphs) | done, verified | round 1 done (28 paragraphs, all confirmed) — round 2 needed and dispatched for 9 more paragraphs missed by ratio-based scanning (invention same-length-or-longer than what it replaced is invisible to that method — important methodological finding) | round 2 done — 9/9 paragraphs changed exactly as specified, independently diffed and confirmed matching drafter's claim exactly | re-verification in progress (Opus) | — |
