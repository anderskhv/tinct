...
**Structure:** 42 chapters match 42 scenes in the same order with the same locations. The 18 SHORT_CHAPTER flags are the genuinely short battle scenes. **But scenes XI–XV get the number 0**, because the parser handles roman numerals only up to X; Coriolanus 1.10 is labelled correctly.
**Verdict: DEFECTS**
