...
- **The fix.** Truncate original-en 3.37 to exactly `Now when the sun had set and darkness was over the land,` (PG #1727, the last line of Book III). This removes no Butler text. The tail echoes Butler's phrasing in places (its longest shared run with PG Book III is 15 words), but only by paraphrasing 3.36, which is retained verbatim. The output hash `0cc76350…6980` independently reproduces the hash recorded for A3 option A in the Odyssey ledger.
