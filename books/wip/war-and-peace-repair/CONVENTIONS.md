...
| Essays ch 338–365 faithful but structurally unchanged (mean sentence 23.5 words, 164 sentences over 50 words); ch 154–278 largely near-verbatim Maude | accessibility | sentence and similarity metrics | **DONE for all 365 chapters**: Gate A scan of 154–365 then 1–153; 47 chapters repaired and accepted (`repair/ACCEPTED.md`). The 25 LIGHT chapters in 158–278 pass Gate A; decided 2026-09-18 (option a) that the two gates are the acceptance evidence |
