...
for ed in ('original-en', 'modern-en'):
    ...
    ok = all(ph[str(ch)][pi] == hashlib.sha256(para(ed, ch, pi).encode()).hexdigest()
             for ch, pi in [(3, 38), (16, 73), (22, 31), (22, 34), (22, 37)])
...
print('author-reported     1edc7e5a76d05a6970430473f442dbbee8913ddcc6cb6686ffb21a81481c9701')
...
for ed in ('original-en', 'modern-en'):
    ...
    print(ed, 'evidence at paragraph ends:', exp == got, '| availableAt at paragraph end:', a == (22, 37, u16len(para(ed, 22, 37))))
cc = patch['candidateCoordinates']
got = [key(e) for e in cc['evidence']]
exp = [(c, p, u16len(para('candidate', c, p))) for c, p in spots]
print('candidateCoordinates evidence correct:', got == exp, '| availableAt correct:', key(cc['availableAt']) == (22, 37, u16len(para('candidate', 22, 37))))
