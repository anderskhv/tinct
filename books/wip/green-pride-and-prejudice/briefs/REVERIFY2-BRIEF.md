...
A. `/home/user/tinct/books/wip/green-pride-and-prejudice/round3/reverify-r2-{{K}}.json`: a
...
B. `.../round3/reverify-r2-{{K}}.md`: a coverage statement (the number of changed paragraphs
