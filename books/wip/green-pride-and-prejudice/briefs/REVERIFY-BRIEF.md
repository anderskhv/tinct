...
A. `/home/user/tinct/books/wip/green-pride-and-prejudice/round2/reverify-r1-{{K}}.json`: a
...
B. `.../round2/reverify-r1-{{K}}.md`: a coverage statement (the number of changed paragraphs
