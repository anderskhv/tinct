...
| 12 | The Merchant of Venice | `merchant-of-venice` | 0.682 | 1 REAL-HEAVY/19 REAL | B | Round 1 fixed 2 defects, claimed clean. Round-2 independent Opus verification confirmed antisemitic/racial content fully intact but found 18 more defects in the same "erasure of source's own printed forms" class that parked Twelfth Night/Midsummer (proper nouns swapped for other forms: Abram->Abraham, Alcides->Hercules, Arragon->Aragon, Colchos->Colchis, etc.; malapropism erasure; an imported editorial emendation + invented gloss; 2 meaning alterations; systematic Exeunt->Exit including 8 grammatically-wrong singular renderings) plus a false verification claim in round 1's own fidelity report. PARKED at 2/3 rounds, see PARKED.md. Round-3 fix pass dispatched (last round before hard park). |
| 13 | Coriolanus | `coriolanus` | 0.683 | 29/29 REAL | B | Round 1 fixed 1 defect, claimed clean. Round-2 independent Opus verification confirmed structure/hash/compression/violence-content clean but found 12 more defects (~30 occurrences) in the same "erasure of source's own printed forms" class that parked Twelfth Night/Merchant/Midsummer (Volsces/Volscians form-mixing incl. all-caps speaker tag, Pebleians->Plebeians, Afric->Africa, Dian's->Diana's, Amazonian chin->beardless chin, 5 coinage erasures, 1 false-friend meaning error "cautelous"->"cautious") plus 3 false verification claims in round 1's own report. PARKED at 2/3 rounds, see PARKED.md. Round-3 fix pass dispatched (last round before hard park). |
