...
| 8 | Julius Caesar | `julius-caesar` | 0.621 | 18/18 REAL | freed | **Publication handoff (blocked).** Text accepted, sha256 `be475cf9c2b8ed2b85be22d8a1f8cb9bb1a89332e31bf390e1272323c02f52b9` (2026-09-21). 1 round (5 paragraphs: Antonius restored ×4, violence softening ×1), independently Opus-verified; re-verified 2026-09-23, no repairs needed. Release packet done. **Not published:** needs the released character package re-anchored and its `characterCards.ts` revision bumped (app code), plus audio regeneration for 5 changed paragraphs. Exact handoff in `books/wip/green-julius-caesar/RELEASE-PACKET.md`. (This single row replaces a stale "queued / Screening done" row and a duplicate "#7" row, reconciled 2026-09-23.) |
...
| 16 | The Merry Wives of Windsor | `merry-wives-of-windsor` | 0.731 | 23/23 REAL | **HARD PARKED** | Round 1 fixed 101 paragraphs, claimed exhaustive; round 2 found 22 more (tag-keyed sweep gap, an uncovered voice, a still-broken joke); round 3 fixed all 22 plus 2 more finds, decided a coinage policy, claimed exhaustive. Round-4 independent Opus verification confirmed round 3's 22 fixes correct but found **14 more defects across 4 characters** on its first pass, including a whole uncovered signature tic (the Host's "bully"/"bully-rook", his most-repeated verbal marker, erased at 9/14 occurrences) and a second structurally-broken joke (Caius asking what "clapper-de-claw" means after the setup "clapper-claw" was erased) — the same failure shape as the ch23 joke that took 3 rounds to fix. Defects-found-per-round trend (101->~14->22->14) never plateaued. 3-round budget spent. **HARD PARKED, no acceptance hash.** See PARKED-RESOLVED.md. |
| 17 | Richard III | `richard-iii` | 0.720 | 25/25 REAL | freed | **Text accepted.** sha256 `e5e713ceee70f643d290357683524f0f0c62a8b1061278b79f51860010137385` (2026-09-21). 4 rounds — round 1 fixed 9 defects, wrongly self-certified clean; round 2 found 15 more (Rougemount/Ha'rfordwest standardization, Exeunt erased at 10/39 locations, Mistress Shore partial fix, dropped invocation), parked 2/3; round 3 fixed all 15 plus 2 minors; round 4 confirmed the class genuinely exhausted via fresh instrumentation, fixed one further narrow inconsistency ("the Sixth"/"Paul's", 2 paragraphs) round 3 had documented but reasoned about incorrectly. Release packet done. |
| 18 | Romeo and Juliet | `romeo-and-juliet` | 0.446 | 25/25 REAL-HEAVY, 1 truncated-quote flag | **HARD PARKED** | Round 1 fixed 12 defects, claimed clean; round 2 found 19 more (register-softening/erasure) + 2 false claims in round 1's report, parked 2/3; round 3 fixed all 19 plus a stage direction, decided an oath-restoration policy, found 4 more fresh instances, fixed 7 non-blocking items (64 paragraphs total), claimed clean. Round-4 independent Opus verification confirmed round 3's work but found **~34 further live instances of the same class** on its first pass: named-thing->generic-descriptor erasures, more crude/bawdy softenings including inside paragraphs round 3 had just edited, coinages flattened at some locations while correctly restored at siblings, an oath policy covering 4 words while ≥8 more remain modernized away (3 distinct interjections all flattened to the single word "Nonsense!"), an uncovered character's signature tic (Peter's "Prates" — the same Merry Wives "bully" shape), and "wanton" still not fully resolved after 4 rounds (2 more instances). Trend never plateaued. 3-round budget spent. **HARD PARKED, no acceptance hash.** Recommends a re-rendering under an explicit written lexical policy, not another patch round. See PARKED-RESOLVED.md. |
| 19 | Macbeth | `macbeth` | 0.483 | 18 REAL-HEAVY/10 REAL | **STRUCTURAL-SKIP** | `books/wip/green-macbeth/source.json` is missing two entire iconic soliloquies present in every standard edition — Lady Macbeth's "unsex me here" speech (Act 1 Sc.5, plus Macbeth's immediate reply) and Macbeth's "Is this a dagger which I see before me" (Act 2 Sc.1) — confirmed by direct text search for ~10 unique terms per passage, zero hits. Same signature both times: a single uninterrupted speech alone onstage as a scene's final dialogue, consistent with an upstream parsing bug at extraction time, not a translation-stage loss (both editions independently lack the same content). Same failure class as Henry V's missing Prologue — content loss in the locked source parse itself, out of scope for a content-repair lane. See `books/wip/green-macbeth/PARKED.md`. Next pool book (The Tempest) pulled in its place. |
| 20 | The Tempest | `the-tempest` | 0.453 | 8 REAL-HEAVY/2 REAL | **HARD PARKED** | Round 1 fixed 14 defects, claimed clean; round 2 found 15 more across 5 classes, parked 2/3; round 3 fixed all 15 plus 7 more found via a fresh location-keyed sweep, wrote a documented lexical policy, claimed clean. Round-4 independent Opus verification confirmed round 3's 23 fixes correct but found **6 blocking + 8 sub-blocking defects across 5 classes** on its first pass — named animals/plants/units still being genericized or mis-specified (adders->snakes, chough->jackdaw wrong species, cubit->inch, the exact same class round 3 itself had just fixed for marmoset/pignuts/leagues), and one fix directly contradicting round 3's own just-written policy. Defects per round (14->15->23->~14) never plateaued. 3-round budget spent. **HARD PARKED, no acceptance hash.** Recommends a re-rendering under a pre-committed concrete-noun/address-form discipline, not another patch round. See PARKED-RESOLVED.md. This concludes first-pass review of all 20 pool books plus both backups. |
| — | Oresteia | `oresteia` | 0.614 | 4 REAL-HEAVY/22 REAL | freed | **Text accepted.** sha256 `8daaaf8606b4e9d24bf6d4e2a759ca4464df42f0d547bf993cb55b91fa36b371` (2026-09-21). 2 rounds — round 1 fixed 13 defects (12 archaic-vocabulary, 1 meaning-narrowing "rapine"->"rape") and self-certified clean with two inaccurate claims. Round 2 independent Opus adversarial pass rebuilt every sweep from source, read all 771 pairs word-for-word, confirmed all 13 fixes, and found 3 more narrow defects (a meaning-inverting typo, a missed sibling of round 1's own fix, a dropped bracket pair). Erasure/register-softening class specifically tested for and found absent; dark content intact at full force; choric register preserved. Release packet done. |
