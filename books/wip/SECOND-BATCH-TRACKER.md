...
| 11 | Twelfth Night | `twelfth-night` | 0.696 | 1 REAL-HEAVY/17 REAL | B | Round 1 fixed 3 defects, claimed clean. Round-2 independent Opus verification found round 1's cited paragraph indices were off-by-one (0-based reported as 1-based) and found 12 more defects in one recurring class ("erasure of source's own printed forms": proper-noun->generic descriptor, silent standard-spelling normalization, malapropism/coinage erasure) — PARKED at 2/3 rounds, see PARKED.md. Round-3 fix pass dispatched (last round before hard park). |
