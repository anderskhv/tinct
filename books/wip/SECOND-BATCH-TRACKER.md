...
| 18 | Romeo and Juliet | `romeo-and-juliet` | 0.446 | 25/25 REAL-HEAVY, 1 truncated-quote flag | B | Round 1 fixed 12 defects (6 mythological proper-noun erasures, 6 register-softenings), confirmed truncated-quote flag was a false positive (source's own mid-sentence self-interruption), claimed clean. Round-2 independent Opus verification confirmed all 12 fixes but found 19 more live register-softening/erasure instances on its first pass (Mercutio's medlar joke gutted incl. "open-arse" erased outright, an imported "cruel"->"civil" emendation, Queen Mab's "hag"/"sluttish" erased, "wanton" sexual sense missed, Nurse's own malapropisms "ropery"/"versal" flattened) plus 2 false verification claims in round 1's own report and a book-wide oath-flattening pattern (Marry/i'faith/Jesu) needing a convention decision. PARKED at 2/3 rounds, see PARKED.md. Round-3 fix pass dispatched (last round before hard park). |
