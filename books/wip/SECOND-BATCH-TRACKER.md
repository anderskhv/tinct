...
| 7 | The Taming of the Shrew | `taming-of-the-shrew` | 0.624 | 12/12 REAL | C | Round-4 verification found a 5th "curst" occurrence missed (Hortensio, ch2/index-1 p30/index-29) due to an 0-based/1-based indexing mismatch between rounds' notes — fixed directly (judgment call, narrow/mechanical), final round-5 confirmation dispatched |
