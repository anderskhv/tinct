# Book 10, paragraphs 34-69 — notes (slice 10b)

## Pusey kept on purpose

- 37: "Late have I loved You, O Beauty so ancient and so new, late have I loved You!" — the famous formula (sero te amavi, pulchritudo tam antiqua et tam nova); follows the Latin and the traditional wording rather than Pusey's "Too late loved I Thee... Beauty of ancient days". Sense-images of the paragraph kept in order.
...
- 34: "I have not found Thee, without it" = extra eam → "I have not found You outside it".
- 38: "Lamentable joys strive with joyous sorrows" (laetitiae flendae cum laetandis maeroribus) → "Joys I should weep over contend with sorrows I should rejoice in"; "without any interval" (sine ullo interstitio) → "without any respite".
- 39: Pusey's "never consumest" = numquam extingueris → "never quenched". The quotation (Wisdom 8:21) left without quote marks, as Pusey has none.
- 40, 46: Pusey "concubinage" = concubitus (sexual intercourse generally, not keeping a concubine) → "sexual union", to avoid a misleading modern sense. Reviewer may prefer another wording.
- 41: "Art Thou not mighty" (Latin: numquid non potens est manus tua) — followed Pusey's wording without "hand"; "such as a thought would restrain" = quantulum possit nutu cohiberi → "not even so slight a one as a passing thought could check" (kept Pusey's sense).
- 42: Pusey "clothe this incorruptible with an eternal incorruption" — Latin corruptibile hoc → rendered "this corruptible body" (Pusey's "incorruptible" appears to be a slip; 1 Cor 15:53).
...
- Triad naming: the assignment mentioned "pride of life", but both Pusey and the Latin in this Book have "ambition of the world" (ambitio saeculi). I kept "ambition of the world" at 40 and "ambitions of the world" at 58. If the project wants "pride of life" for recognizability, change 40 only and record it; 58 is a different phrase (Latin plural) and should stay.
- 45: restored "John" (the Baptist) from the Latin where the served Pusey text drops the name. Style note section 7 says not to add names Pusey does not use; this seems a transmission slip in the served original, but a reviewer should confirm.
- 40/46: "sexual union" for Pusey's "concubinage".
- 67 (0.71), 68 (0.68), 69 (0.72) have the highest similarity in the slice because they are dense with scripture and doctrinal formulae kept term-exact on purpose; all under 0.75.

## Check output

`book 10: 70/70 paras, weighted sim 0.515 (target <=0.65), flagged 0`

Range 34-69: no THOU forms, no IDENTICAL, no archaic hits; ratios 1.02-1.18; similarity 0.38-0.72 (highest: 69 0.72, 67 0.71, 42 0.68, 68 0.68).
