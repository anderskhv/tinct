...
TARGETS=[("pride-and-prejudice",2,[10]),("the-awakening",12,[1])]
book,ch,indices=TARGETS[int(sys.argv[1])];key=f"{book}/original-en/ch{ch}"
root=Path("artifacts/bella-focused-context-2026-09-21")/book/str(ch);root.mkdir(parents=True,exist_ok=True)
