...
Revision 5 (2026-09-17) of the pinned ``f5b23de7`` helper, built on revision 4.
...
footnote labels and superscript verse markers remain zero-span source words.
...
def clean_text(text: str) -> str:
    """Acoustic edition text: Kokoro-style cleanup plus revision-5 cue stripping."""
    superscripts = "⁰¹²³⁴⁵⁶⁷⁸⁹"
...
# ALL-CAPS speaker labels and Enter/Exeunt names are dropped from the
# acoustic denominator separately (see ``clean_text`` / ``_mark_structural_cues``).
