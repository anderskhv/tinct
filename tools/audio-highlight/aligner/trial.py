...
import pinned_words_sidecar_lib_v6 as lib
...
# Default v6; --helper v1 reproduces run 1 exactly
# and --helper v2 reproduces run 2.
HELPERS={'v1':'pinned_words_sidecar_lib','v2':'pinned_words_sidecar_lib_v2','v3':'pinned_words_sidecar_lib_v3','v4':'pinned_words_sidecar_lib_v4','v5':'pinned_words_sidecar_lib_v5','v6':'pinned_words_sidecar_lib_v6'};DEFAULT_HELPER='v6'
