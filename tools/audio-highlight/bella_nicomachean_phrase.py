...
book,ch,indices=[("nicomachean-ethics",7,[57])][int(sys.argv[1])]
key=f"{book}/original-en/ch{ch}";root=Path("artifacts/bella-focused-nicomachean-phrase-2026-09-21")/book/str(ch);root.mkdir(parents=True,exist_ok=True);work=Path("/tmp/short-clips")
...
def prior(n):return get("codex/bella-focused-nicomachean-resume-20260921","bella-focused-acoustic-2026-09-21",n)
